...
class PhotosViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
  private lazy var remoteUrls: [URL] = (0 ..< 10).map { URL(string: "https://github.com/cuzv/SlidingPhoto/raw/master/Example/Images.bundle/image-small-\($0).jpg")! }
  ...
  @IBOutlet var loadImageSettingSwitch: UISwitch!
  ...
  override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    cell.imageView.kf.setImage(with: url, completionHandler: { [weak cell] (result: Result<RetrieveImageResult, KingfisherError>) in
      cell?.imageView.sp.image = (try? result.get())?.image
    })
